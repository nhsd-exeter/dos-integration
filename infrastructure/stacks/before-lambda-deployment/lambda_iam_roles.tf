...
module "service_matcher" {
  ...
  lambda_name       = var.service_matcher_lambda
  use_custom_policy = true
  custom_lambda_policy = jsonencode(
    {
      "Version" : "2012-10-17",
      "Statement" : [
        {
        ...
        },
        {
          ...
          "Resource" : "arn:aws:sqs:${var.aws_region}:${var.aws_account_id}:${var.holding_queue}"
        },
        {
          "Effect" : "Allow",
          "Action" : [
          ...
          "Resource" : "arn:aws:sqs:${var.aws_region}:${var.aws_account_id}:${var.update_request_queue}"
        },
        {
          "Effect" : "Allow",
          "Action" : [
...
module "service_sync" {
  source            = "../../modules/lambda-iam-role"
  lambda_name       = var.service_sync_lambda
  use_custom_policy = true
  custom_lambda_policy = jsonencode(
    {
      "Version" : "2012-10-17",
      "Statement" : [
        ...
        },
        {
          ...
          "Resource" : "arn:aws:lambda:${var.aws_region}:${var.aws_account_id}:function:${var.send_email_lambda}"
        }
      ]
    }
  )
...
module "change_event_dlq_handler" {
  source            = "../../modules/lambda-iam-role"
  lambda_name       = var.change_event_dlq_handler_lambda
  use_custom_policy = true
  custom_lambda_policy = jsonencode(
    {
      "Version" : "2012-10-17",
...
module "dos_db_update_dlq_handler" {
  source            = "../../modules/lambda-iam-role"
  lambda_name       = var.dos_db_update_dlq_handler_lambda
  use_custom_policy = true
  custom_lambda_policy = jsonencode(
    {
      "Version" : "2012-10-17",
...
module "dos_db_handler" {
  ...
  source            = "../../modules/lambda-iam-role"
  lambda_name       = var.dos_db_handler_lambda
  use_custom_policy = true
  custom_lambda_policy = jsonencode(
    {
      "Version" : "2012-10-17",
...
module "send_email" {
  source            = "../../modules/lambda-iam-role"
  lambda_name       = var.send_email_lambda
  use_custom_policy = true
  custom_lambda_policy = jsonencode(
    {
      "Version" : "2012-10-17",
...
module "ingest_change_event" {
  source            = "../../modules/lambda-iam-role"
  lambda_name       = var.ingest_change_event_lambda
  use_custom_policy = true
  custom_lambda_policy = jsonencode(
    {
      "Version" : "2012-10-17",
      "Statement" : [
        ...
        },
        {
          ...
          "Resource" : "arn:aws:sqs:${var.aws_region}:${var.aws_account_id}:${var.change_event_queue}"
        },
        {
          "Effect" : "Allow",
          "Action" : [
...
module "quality_checker" {
  source            = "../../modules/lambda-iam-role"
  lambda_name       = var.quality_checker_lambda
  use_custom_policy = true
  custom_lambda_policy = jsonencode(
    {
      "Version" : "2012-10-17",
