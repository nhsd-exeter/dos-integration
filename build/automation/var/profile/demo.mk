...
DB_ROUTE_53 := uec-core-dos-put-dos-primary-rw.dos-db-put
DB_REPLICA_SERVER_NAME := uec-core-dos-put-db-12-replica-di
DB_REPLICA_53 := uec-core-dos-put-di-ro.dos-db-put
DB_PORT := 5432
DB_NAME := pathwaysdos_uat2
DB_SCHEMA := pathwaysdos
DOS_DB_SG_NAME := uec-core-dos-put-datastore-di-sg
DOS_DB_REPLICA_SG_NAME := uec-core-dos-put-datastore-di-sg
