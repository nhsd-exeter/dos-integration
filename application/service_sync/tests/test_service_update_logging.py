...
def test_dos_logger(service_update_logger: ServiceUpdateLogger):
    # Assert
    assert service_update_logger.logger.name == "dos_logger"
    assert service_update_logger.logger.level == INFO
    ...
    assert service_update_logger.correlation_id == CORRELATION_ID
...
def test_service_update_logger_get_action_name_remove(dos_loservice_update_loggergger: ServiceUpdateLogger):
    # Act
