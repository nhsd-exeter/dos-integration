...
BLOOD_PRESSURE = {"dos_type_id": DOS_BLOOD_PRESSURE_TYPE_ID,
                "nhs_uk_service_code": NHS_UK_BLOOD_PRESSURE_SERVICE_CODE,
                "symptom_group": DOS_BLOOD_PRESSURE_SYMPTOM_GROUP,
                "symptom_discriminator": DOS_BLOOD_PRESSURE_SYMPTOM_DISCRIMINATOR,
                "sg_sd_id": DOS_BLOOD_PRESSURE_SGSDID,
                "name": "Blood Pressure"}
...
CONTRACEPTION = {"dos_type_id": DOS_CONTRACEPTION_TYPE_ID,
                "nhs_uk_service_code": NHS_UK_CONTRACEPTION_SERVICE_CODE,
                "symptom_group": DOS_CONTRACEPTION_SYMPTOM_GROUP,
                "symptom_discriminator": DOS_CONTRACEPTION_SYMPTOM_DISCRIMINATOR,
                "sg_sd_id": DOS_CONTRACEPTION_SGSDID,
                "name": "Contraception"}
