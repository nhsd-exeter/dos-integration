...
BLOOD_PRESSURE = SubServiceConstants("Blood Pressure", NHS_UK_BLOOD_PRESSURE_SERVICE_CODE, DOS_BLOOD_PRESSURE_TYPE_ID,
                                    DOS_BLOOD_PRESSURE_SYMPTOM_GROUP, DOS_BLOOD_PRESSURE_SYMPTOM_DISCRIMINATOR,
                                    DOS_BLOOD_PRESSURE_SGSDID)

CONTRACEPTION = SubServiceConstants("Contraception", NHS_UK_CONTRACEPTION_SERVICE_CODE, DOS_CONTRACEPTION_TYPE_ID,
                                    DOS_CONTRACEPTION_SYMPTOM_GROUP, DOS_CONTRACEPTION_SYMPTOM_DISCRIMINATOR,
